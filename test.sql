...
CREATE TABLE appl_questionnaire_answer (
    ...
    ques_consent_quesnnaire_map_id int NOT NULL,
...
CREATE TABLE job_post_activity (
    ...
    job_application_status_id int NOT NULL,
...
CREATE TABLE job_post_activity_log (
    id int NOT NULL,
    job_post_activity_id int NOT NULL,
    job_post_action_id int NOT NULL,
...
CREATE TABLE job_post_questionnaire (
    id int NOT NULL,
    job_post_id int NOT NULL,
    consent_questionnaire_id int NOT NULL,
...
CREATE TABLE product_bundle (
    id int NOT NULL,
    product_bundle_name varchar(50) NOT NULL,
    inception_date date NOT NULL,
    is_active char(1) NOT NULL,
    subscription_cost int NOT NULL,
